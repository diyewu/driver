package xz.research.common.generator;
...
public class CodeGenerator {
    ...
    // 数据库 URL
    private static final String URL = "jdbc:mysql://118.24.85.246:13408/febs_shiro_jwt?useUnicode=true&characterEncoding=UTF-8&useJDBCCompliantTimezoneShift=true&useLegacyDatetimeCode=false&serverTimezone=UTC";
    // 数据库驱动
    private static final String DRIVER_NAME = "com.mysql.cj.jdbc.Driver";
    // 数据库用户名
    private static final String USERNAME = "febtest";
    // 数据库密码
    private static final String PASSWORD = "upVKp76F8LaABOCj";
    // @author 值
    private static final String AUTHOR = "ZhongLe";
    // 包的基础路径
    private static final String BASE_PACKAGE_URL = "xz.research";
    // xml文件路径
    ...
    public static void main(String[] args) {
        ...
        packageConfig.setModuleName("manager");
